...
export default function GallerySection() {
    ...
    const altTexts = [
        ...
        "Aménagement intérieur et création bois Fribourg",
        "Architecture et rénovation de l'habitat Neuchâtel",
        "Couverture et ferblanterie par l'entreprise Enzo Seker",
        "Projet d'architecture d'intérieur sur mesure Fribourg",
        "Chantier de rénovation complète Valangin",
        "Réalisation menuiserie et agencement d'espaces Neuchâtel",
        "Entretien de toiture et travaux de couverture",
        "Direction de travaux pour rénovation Fribourg",
        "Agencement bois et menuiserie architecture Neuchâtel",
        "Restauration de charpente traditionnelle Valangin",
        "Architecture et design intérieur Enzo Seker Fribourg",
        "Rénovation énergétique et menuiserie extérieure",
        "Création de meubles sur mesure menuiserie Neuchâtel",
        "Réfection entière de toiture et couverture",
        "Suivi de chantier de rénovation par Enzo Seker",
        "Pose de parquet bois massif et menuiserie intérieure Fribourg",
        "Rénovation de façade et embellissement bâtiment Neuchâtel",
        "Agencement de cuisine d'architecte sur mesure",
        "Transformation d'espace intérieur rénovation Valangin",
        "Travaux de menuiserie spécialisée Fribourg Neuchâtel",
        "Couverture traditionnelle et rénovation complète de toit",
        "Conception et architecture d'aménagement intérieur",
        "Rénovation d'appartement complet Enzo Seker",
        "Menuiserie artisanale et créations bois contemporaines Fribourg",
        "Réhabilitation de bâtiment ancien et charpente",
        "Direction de travaux et pilotage de chantier Neuchâtel",
        "Aménagement de combles et menuiserie Fribourg",
        "Architecture et rénovation de maison individuelle",
        "Travaux de menuiserie bois haut de gamme Enzo Seker",
        "Intervention d'urgence en couverture et zinguerie",
        "Projet de rénovation avec suivi architectural rigoureux",
        "Pose d'escalier bois menuiserie traditionnelle Neuchâtel",
